...
void Compressor::flushBuffer(char *buff, ofstream &out)
{
    ...
    strcpy(buff, buff + byte_count * 8);
}

void Compressor::compress(string srcFilePath, string outDirPath)
{
    fstream src;
    ...
    string outFilePath = outDirPath;
    outFilePath += "\\";
    outFilePath += getPrefix(srcFilePath);
    outFilePath += ".haff";
    ...
    string fileSuffix = getSuffix(srcFilePath);
